...
import { TrendingUp, Shield, Zap, ArrowRight, BarChart3, Target, DollarSign, CheckCircle } from "lucide-react";
...
export function HeroBanner() {
  ...
  return (
    <section className="relative py-20 md:py-28 px-4 overflow-hidden border-b border-border">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_50%,hsl(168_80%_45%/0.12),transparent_50%)]" />
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_80%_30%,hsl(168_65%_55%/0.08),transparent_50%)]" />
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button
                size="lg"
                className="bg-gradient-to-r from-primary to-primary-light hover:opacity-90 text-primary-foreground text-lg px-8 py-6 h-auto font-semibold"
      ...
      <div className="container mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
          {models.map((model, i) => (
            <Card
              key={i}
              className="relative p-6 bg-card border-border hover:border-primary/30 transition-all cursor-pointer group"
              onClick={() => navigate("/buy-challenge")}
            >
              {model.tag === "Popular" && (
    ...
    <section className="py-20 px-4 bg-card/30">
      <div className="container mx-auto">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
          {features.map((f, i) => (
            <div key={i} className="p-6 rounded-xl bg-card border border-border space-y-3">
    ...
    <section className="py-20 px-4">
      <div className="container mx-auto">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl mx-auto">
          {steps.map((s, i) => (
            <div key={i} className="text-center space-y-4">
              <div className="w-16 h-16 mx-auto rounded-full bg-gradient-to-br from-primary/20 to-primary/5 border border-primary/20 flex items-center justify-center">
        ...
        <div className="text-center mt-12">
          <Button
            size="lg"
            className="bg-gradient-to-r from-primary to-primary-light text-primary-foreground px-8 py-6 h-auto text-lg font-semibold"
            onClick={() => navigate("/buy-challenge")}
          >
